...
Welcome to `pdf2svg2pdf` contributor's guide.
...
If you experience bugs or general issues with `pdf2svg2pdf`, please have a look
...
You can help improve `pdf2svg2pdf` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`pdf2svg2pdf` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `pdf2svg2pdf`'s files. While this mechanism can
...
```
conda create -n pdf2svg2pdf python=3 six virtualenv pytest pytest-cov
conda activate pdf2svg2pdf
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/pdf2svg2pdf.git
   cd pdf2svg2pdf
   ```
...
5. Install [pre-commit]:
   ...
   `pdf2svg2pdf` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/pdf2svg2pdf
[issue tracker]: https://github.com/<USERNAME>/pdf2svg2pdf/issues
